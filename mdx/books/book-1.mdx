...
- Phabby shares she's heard a lot of different facts, like everything in the computer is just 1s and 0s.
- Choco is very intrigued and asks how can they be all 1s and 0s when your dad is writing code.
- Phabby shrugs.
...
- Their neighbor is **George Boole**. A self taught computer programmer that loves to ramble.
...
- He asks how much they know and Phabby responds with just knowing that everything is supposed be just 1 and 0s.
- George becomes exuberant.
- He suggests they take a step back from 1s and 0s and shares, we first need to learn how the computer thinks through logic.
- Phabby responds that people only talk about logic when they are right.
- George becoming more giddy, points out that any yes or no question is a logic statement. So coming to his house to learn to code is logical!
- <GatsbyImage
...
- George Boole explains
  - first we can change any yes or no to true and false.
    - introduces some basic propositional logic statement syntax
...
### Boolean Logic as Numerical Representation

- _Simple let's swap out True and False with 1 and 0_
- If we can swap out 1 and 0 as True and False, what else can represent True and False?
- Phabby → how about a and b?
- George → great!
- Choco → Or this coin, if it's heads it could be true or tails it could be false!
- George → Yes, so physical things can do this same operation. That's how computers work!
- Phabyy & Choco are puzzled, how can that be?
- George → let me show you an old computer!
  - Has a display of tube computer with lights
  - The lights represent if something is true or false.

### Binary Numbers

- Use lightbulbs can also represent numbers!
